...
const menuData = [
  // NOVIDADES INSERIDAS AQUI COM LAYOUT DE CARDS
  {
    ...
    itens: [
      { 
        nome: "Sugestão 1", 
        descricao: "Filé de frango (150g). Acompanha arroz colorido ou purê de abóbora.", 
        preco: 32.90,
      ...
      { 
        ...
        descricao: "Panqueca integral de ricota com espinafre (200g). Acompanha salada ou arroz colorido.", 
        preco: 35.90,
